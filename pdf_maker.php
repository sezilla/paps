...
if($count>0) 
{
	...
	<tr><td colspan="2" align="center"><b>Manila Academy for Mathematics and Sciences</b></td></tr>
	<tr><td colspan="2" align="center"><b>Manila, Philippines</b></td></tr>
	<tr><td colspan="2" align="center"><b>Office of the Campus Registrar</b></td></tr>
    <tr><td colspan="2" align="center"><b>Certificate of Grades</b></td></tr>
	<tr><td colspan="2"><b>Full Name: '.$inv_mst_data_row['CUSTOMER_NAME'].' </b></td><td align="right"><b>Student No.: '.date("d-m-Y").'</b> </td></tr>
	<tr><td><b>Year Level: '.$inv_mst_data_row['CUSTOMER_MOBILENO'].' </b></td><td align="right"><b>Academic Year: '.date("d-m-Y").'</b> </td></tr>
	<tr><td><b>Course: '.$inv_mst_data_row['ADDRESS'].' </b></td></tr>
    <tr><td><b>Date: '.date("d-m-Y").'</b></td></tr>
	...
	<tr><td colspan="2">&nbsp;</td></tr>
    <tr><td colspan="2" align="center"><b>Total Subjects Enrolled       :       '.date("d-m-Y").'</b></td></tr>
    <tr><td colspan="2" align="center"><b>Total Credits Enrolled       :       '.date("d-m-Y").'</b></td></tr>
    <tr><td colspan="2" align="center"><b>Total Credits Earned       :       '.date("d-m-Y").'</b></td></tr>
    <tr><td colspan="2" align="center"><b></b></td></tr>
    <tr><td colspan="2" align="center"><b>Grade Point Average       :       '.date("d-m-Y").'</b></td></tr>
    <tr><td colspan="2" align="center"><b></b></td></tr>
    <tr><td><b>REMARKS: '.date("d-m-Y").'</b></td></tr>
    <tr><td colspan="2">&nbsp;</td><td align="right"><b>'.date("d-m-Y").'</b> </td></tr>
    <tr><td colspan="2">&nbsp;</td><td align="right"><b>Register Staff</b> </td></tr>
