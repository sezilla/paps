...
if(isset($_POST["submit"])){
  ...
  VALUES ('$fullname','$student_num','$program','$yr_sec','$dob','$sem', '$purpose', 'Good Moral')";
...
<html lang="en">
  <head>
    ...
    <title>Request for Good Moral</title>
  ...
  >
    <div class="flex flex-col items-stretch pl-12 pr-12 max-md:px-5">
      ...
      >
        <span>Please ensure that you have provided all the necessary information before submitting your request to the registrar.
        </span></br>
        <span>Once done, entrust the process to us, and your 
        <span class="font-bold">Good Moral certificate </span>
