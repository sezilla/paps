...
if(isset($_POST["submit"])){
  ...
  VALUES ('$fullname','$student_num','$program','$yr_sec','$dob','$sem', '$purpose', 'Certificate of Grade')";
...
<html lang="en">
  <head>
    ...
    <title>Request for Certificate of Grade</title>
  ...
  >
    <div class="flex flex-col items-stretch pl-12 pr-12 max-md:px-5">
      ...
      >
        Request Certificate of Grade
      </h1>
      <div class="pr-12 pl-4">
      <p
        class="text-orange-950 text-lg leading-8 w-full ml-4 mr-5 mt-6 max-md:max-w-full"
      >
        <span>Please ensure all necessary information is accurately provided before submitting your request to the registrar. 
        </span></br>
        <span> Afterward, entrust the process to us, and your 
